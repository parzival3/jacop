...
public final class BigIntegerInterval implements Cloneable {
    ...
    public BigIntegerInterval(BigInteger min, BigInteger max) {
        ...
        assert (min.compareTo(max) < 0) : "min value " + min + " is larger than max value " + max;
     ...
     */
    public boolean eq(BigIntegerInterval interval) {
    ...
    public boolean singleton(BigInteger c) {
        return (min.compareTo(max) == 0 && min.compareTo(c) == 0);
    }
