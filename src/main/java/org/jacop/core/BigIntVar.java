...
public class BigIntVar extends Var {
     ...
     */
    public BigIntVar(Store store, String name, BigIntDomain dom) {

        commonInitialization(store, name, dom);

    }

    private void commonInitialization(Store store, String name, BigIntDomain dom) {

        dom.searchConstraints = new ArrayList<Constraint>();
        dom.modelConstraints = new Constraint[BigIntDomain.eventsInclusion.length][];
        dom.modelConstraintsToEvaluate = new int[BigIntDomain.eventsInclusion.length];
     ...
     * @param dom   the domain of the variable being created.
     */
    public BigIntVar(Store store, BigIntDomain dom) {
     ...
     */
    public BigIntVar(Store store, int min, int max) {
     ...
     * @param name  the name for the variable being created.
     */
    public BigIntVar(Store store, String name) {
     ...
     */
    public BigIntVar(Store store, String name, int min, int max) {
    ...
    public void setDomain(BigIntDomain dom) {
    ...
    public void addDom(BigIntDomain dom) {
        domain.addDom(dom);
    }
     ...
     */
    public BigIntDomain recentDomainPruning() {
    ...
    public void domainHasChanged(int event) {
        ...
        assert ((event == BigIntDomain.ANY && !singleton()) || (event == BigIntDomain.BOUND && !singleton()) || (event == BigIntDomain.GROUND
    ...
    public void putConstraint(Constraint c) {
        putModelConstraint(c, BigIntDomain.ANY);
    }
